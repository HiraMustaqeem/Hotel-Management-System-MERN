...
if (loading) {
 ...
 {/* ─── HEADER PANEL SECTION ─── */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4 pb-1 border-b border-slate-200/60 mt-3">
...
<div className="max-w-7xl mx-auto mb-10">
  ...
  <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
    ...
    <div className="absolute -top-24 -right-24 w-80 h-80 bg-indigo-100 blur-3xl rounded-full"></div>
    <div className="absolute -bottom-24 -left-24 w-80 h-80 bg-violet-100 blur-3xl rounded-full"></div>
    ...
    <div className="relative p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 mt-2 max-w-2xl leading-relaxed">
          Real-time operations stream, financial analytics, transactional tracking,
          and system performance monitoring for enterprise-level management.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <div className="px-4 py-3 rounded-2xl bg-violet-50 border border-violet-100">
          <p className="text-[10px] font-bold uppercase text-slate-500">Occupancy</p>
          <p className="text-sm font-black text-violet-600">
            {dashboardData?.occupancyRate || 0}%
          </p>
        </div>

          <div className="px-4 py-3 rounded-2xl bg-emerald-50 border border-emerald-100 w-52">
          <p className="text-[10px] font-bold uppercase text-slate-500">System</p>
          <p className="text-sm font-black text-emerald-600">Operational</p>
        </div>
