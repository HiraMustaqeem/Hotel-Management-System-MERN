...
const Rooms = () => {
    ...
    return (
        <section className="py-24 px-6 md:px-16 lg:px-24 bg-slate-50/50">
            
            {/* HEADER */}
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                <div className="max-w-xl">
                    <span className="text-indigo-600 font-bold uppercase tracking-[3px] text-xs">
                        Our Accommodations
                    </span>
                    <h2 className="text-4xl md:text-5xl font-black text-gray-900 mt-4 leading-tight">
                        Find Your <span className="italic text-indigo-600">Home</span> Away From Home
                    </h2>
                </div>
            </div>
